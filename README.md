...
[![user guide](https://img.shields.io/badge/-user%20guide-blue)](https://registry.terraform.io/providers/dtrouillet/bitbucketserver/latest)
...
See [User Guide](https://dtrouillet.github.io/terraform-provider-bitbucketserver) for details on all the provided data and resource types.
...
- clone this repository to `$GOPATH/src/github.com/dtrouillet/terraform-provider-bitbucketserver`
